            ...
            return {
                ...
                link: function() {
                    var listener = function(event, toState) {
                        var default_title = 'Altair Admin RTL';
                        $timeout(function() {
                        ...
                        $thisCard
                            ...
                            .velocity({
                                ...
                                begin: function(elements) {
                                    ...
                                    $rootScope.hide_content_sidebar = true;
                                    // add back button
                                    $thisCard.append('<span class="md-icon material-icons uk-position-top-right cardFSDeactivate" style="margin:10px 0 0 10px">&#xE5CD;</span>')
                                }
                            })
                            // resize card to full width/height
                            .velocity({
            ...
            return {
                ...
                link: function (scope, el, attrs) {
                    ...
                    function updateCard(percent) {
                        ...
                        $this
                            .css({ 'background': '-moz-linear-gradient(right, '+bg_color+' '+percent+'%, #fff '+(percent)+'%)'})
                            .css({ 'background': '-webkit-linear-gradient(right, '+bg_color+' '+percent+'%, #fff '+(percent)+'%)'})
                            .css({ 'background': 'linear-gradient(to left,  '+bg_color+' '+percent+'%, #fff '+(percent)+'%)'});
