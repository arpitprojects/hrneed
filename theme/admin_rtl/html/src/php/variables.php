...
if(substr($sPage, 0, 5 ) === "forms") {
    ...
    <script src="'.$bower_url.'/ckeditor/lang/ar.js"></script>
...
if(substr($sPage, 0, 7 ) === "plugins") {
    ...
    <script src="file_manager/js/i18n/elfinder.ar.js"></script>
    ...
    $scripts = '
    <!-- push.js -->
    <script src="'.$bower_url.'/push.js/push'.$dist_min.'.js"></script>
