...
var release_dir = '../../_release/'+version+'/',
    ...
    release_landing_page_dir = release_dir + '/altair_v'+version+'/landing_page_rtl/';
...
gulp.task('release_dist_copy',function() {
    ...
    var bower_files = gulp.src([
            ...
            '!bower_components/{echarts,echarts/**}',
...
gulp.task('release_landing_page', function() {
    gulp.src([
        '../../landing_page_rtl/**',
        '!../../landing_page_rtl/.gitignore',
        '!../../landing_page_rtl/.idea/',
        '!../../landing_page_rtl/.idea/**',
        '!../../landing_page_rtl/node_modules/',
        '!../../landing_page_rtl/node_modules/**'
    ],{ dot: true })
...
gulp.task('release',function(callback){
    return runSequence(
        ...
        ['release_dist_copy','release_angular_copy','release_src_copy','release_landing_page'],
