                                ...
                                <div class="uk-grid uk-grid-width-medium-1-3 uk-margin-large-bottom" data-uk-grid-margin>
                                    <div>
                                        <div class="uk-input-group">
                                            ...
                                            <input class="md-input" type="text" id="clndr_event_date_control" data-uk-datepicker="{format:'YYYY-MM-DD', minDate: '<?php $moment = new Moment\Moment(); echo $moment->format('Y-m-d'); ?>' }">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="uk-input-group">
