                                    ...
                                    <div class="uk-width-medium-8-10">
                                        <div class="uk-overflow-container">
                                            <table class="uk-table">
                                                ...
                                                <tbody>
                                                    <tr class="form_section">
                                                        ...
                                                        <td class="uk-text-right uk-text-middle"><a href="#" class="btnSectionRemove"><i class="material-icons md-24">&#xE872;</i></a></td>
                                                    </tr>
                                                    <tr class="form_section">
                                                    ...
                                                    <tr class="form_section">
                                                        <td><input type="text" class="md-input md-input-width-medium" value="Red" /></td>
                                                        <td class="uk-text-center uk-text-middle"><input type="checkbox" data-md-icheck checked /></td>
                                            ...
                                            <script id="field_template_a" type="text/x-handlebars-template">
                                                <tr class="form_section">
                                                    <td class="uk-width-4-10"><input type="text" class="md-input md-input-width-medium" placeholder="Color" /></td>
                                                    <td class="uk-width-2-10 uk-text-middle uk-text-center"><input type="checkbox" data-md-icheck /></td>
                                        ...
                                        <div class="uk-overflow-container">
                                            <table class="uk-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="uk-padding-remove">
                                                            <table class="uk-table" data-dynamic-fields="field_template_b"></table>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <script id="field_template_b" type="text/x-handlebars-template">
                                                <tr class="form_section">
                                                    <td class="uk-width-4-10"><input type="text" class="md-input md-input-width-medium" placeholder="Memory" /></td>
